...
<style>
    ...
    .bg-100     { background: #FF4136; }
    .bg-200     { background: #FF851B; }
    .bg-300     { background: #FFDC00; }
    .bg-500     { background: #2ECC40; }
    .bg-700     { background: #39CCCC; }
    .bg-1000    { background: #0074D9; }
    .bg-1500    { background: #B10DC9; }
    .bg-2500    { background: #F012BE; }
    .bg-3000    { background: #85144b; }
    ...
    .up-container { width: 100%; padding: 0 3px; }
    ...
    .meta-badge.price    { background: #fef3c7; color: #92400e; border-color: #fde68a; }
    .meta-badge.validity { background: #dbeafe; color: #1e40af; border-color: #bfdbfe; }
    ...
    .seller-line strong { color: #334155; font-weight: 800; }
</style>
    ...
    <div class="voucher-body">
        ...
        <?php if (!empty($voucherSellerName)) { ?>
            <div class="seller-line">
                <strong><?= isset($_sold_by) ? htmlspecialchars($_sold_by, ENT_QUOTES, 'UTF-8') : 'Vendu par'; ?>:</strong>

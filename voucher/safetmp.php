...
<style>
    ...
    .bg-100  { background: #64748b; }
    .bg-200  { background: linear-gradient(135deg, #0ea5e9 0%, #0284c7 100%); }
    .bg-300  { background: #0891b2; }
    .bg-500  { background: linear-gradient(135deg, #10b981 0%, #059669 100%); }
    .bg-1000 { background: #ea580c; }
    .bg-1500 { background: linear-gradient(135deg, #8b5cf6 0%, #7c3aed 100%); }
    .bg-3000 { background: #dc2626; }
    .bg-default { background: #6366f1; }
